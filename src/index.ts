class CbLoremImage {
  ...
  svg(width: number, height: number, color: string) {
...
console.log(this.textColor);
    ...
    const svgString = `
        <svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}">
            <defs>
                ...
                <path id="I9" vd="m 2.9,-8.9 c 0,-1.68 1.18,-2.8 2.7,-2.8 1.88,0 3.02,1.32 3.28,3.8 -1.04,1.2 -2.26,1.7 -3.26,1.7 -1.78,0 -2.72,-0.96 -2.72,-2.7 z m 2.24,9.14 c 2.76,0 5.34,-1.98 5.34,-7.1 0,-4.1 -2.12,-6.14 -4.9,-6.14 -2.26,0 -4.24,1.66 -4.24,4.1 0,2.62 1.6,3.94 3.96,3.94 1.3,0 2.58,-0.62 3.62,-1.64 -0.08,4.08 -1.86,5.48 -3.88,5.48 -0.98,0 -1.9,-0.4 -2.54,-1.02 L 1.58,-1.1 c 0.84,0.76 2,1.34 3.56,1.34 z" />
            ...
            <g transform="translate(${width / 2}, ${height / 2}) scale(${this.textScale})">
  ...
  setFontSize() {
    ...
    if (this.height / 4 < this.fontSize) {
